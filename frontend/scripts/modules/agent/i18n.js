...
export const i18n = {
  zh: {
    ...
    parseHotVideoBtn: "解析复刻",
    parseHotVideoPh: "粘贴爆款视频链接并解析复刻",
    startHotVideoRemake: "一键复刻",
    hotVideoWorking: "正在解析爆款视频，请稍候...",
    hotVideoStep1: "正在拉取参考视频并准备转写…",
    hotVideoStep2: "正在提取字幕与钩子信息…",
    hotVideoStep3: "正在拆解节奏、镜头与 CTA 结构…",
    hotVideoStep4: "正在生成复刻脚本与视频提示词…",
    hotVideoSlow: "爆款视频解析仍在进行（已用时 {sec}s），请稍候…",
    hotVideoDone: "爆款视频解析完成，已生成复刻脚本与提示词。",
    hotVideoDoneFallback: "爆款视频已生成兜底复刻脚本与提示词，但未完成真实视频字幕拆解。",
    hotVideoDoneLlmFallback: "爆款视频解析完成，但 LLM 拆解服务鉴权失败，当前使用转写结果生成的兜底复刻脚本。",
    hotVideoFail: "爆款视频解析失败，请检查视频链接或稍后重试。",
    hotVideoFailShareUnresolved: "这是一个分享页链接，但暂时没解析出可下载的视频直链。建议换成公开视频页、可直接下载的 mp4 链接，或稍后再试。",
    hotVideoReady: "复刻内容已准备好，可直接一键复刻或继续编辑脚本。",
    hotVideoReadyFallback: "当前复刻内容基于兜底模板生成，可继续编辑或一键复刻；若想更贴近原视频，建议换可下载视频直链后重试。",
  ...
  en: {
    ...
    parseHotVideoBtn: "Analyze & Remake",
    parseHotVideoPh: "Paste a viral video URL to analyze and remake",
    startHotVideoRemake: "One-click Remake",
    hotVideoWorking: "Analyzing the reference video...",
    hotVideoStep1: "Fetching the reference video and preparing transcription…",
    hotVideoStep2: "Extracting subtitles and hook signals…",
    hotVideoStep3: "Breaking down pacing, shots, and CTA structure…",
    hotVideoStep4: "Generating the remake script and video prompt…",
    hotVideoSlow: "Video analysis is still running ({sec}s). Please wait…",
    hotVideoDone: "Reference video analysis completed and the remake package is ready.",
    hotVideoDoneFallback: "A fallback remake package is ready, but subtitle extraction from the real video did not complete.",
    hotVideoDoneLlmFallback: "Reference video parsing completed, but the LLM analysis service authentication failed. A fallback remake package was generated from the transcript.",
    ...
    hotVideoReady: "The remake package is ready. You can generate now or keep editing the script.",
    hotVideoReadyFallback: "This remake package was generated from a fallback template. You can still edit or generate now, but a direct downloadable video URL will produce a closer remake.",
