...
export const i18n = {
  ...
  en: {
    ...
    welcome:
      "Hi — I'm Shoplive's AI assistant 😊 You can generate with one prompt, or upload references for automatic product understanding and prompt fill-in.\nIt also supports product-link parsing, AI image generation, first/last frame control, up to 3 concurrent jobs, and post-generation video/script editing.",
